...
export const subServices: SubService[] = [
  {
    ...
    overview: {
      ...
      paragraphs: [
        "Shopify dominates e-commerce for good reason: a mature plugin ecosystem, reliable checkout and payments infrastructure, and a platform that scales from a first sale to enterprise volume without a full re-platform. The tradeoff is that most stores never use more than a fraction of what Shopify can actually do. The default theme customization options are genuinely limited — anything beyond basic layout changes requires real development, in Liquid or through Shopify's newer Hydrogen/Remix framework for headless storefronts.",
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Payment and checkout configuration varies more than most platform comparisons acknowledge. Different regions favor different payment methods, subscription billing has its own requirements separate from one-time purchases, and B2B checkout flows often need approval steps a standard B2C checkout was never designed to support. We configure for your actual transaction types rather than assuming a generic checkout setup covers every business model equally well — that assumption is where many implementations quietly fail later.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        "Local search results include a distinct 'map pack' surface — the three local business listings shown above standard organic results for location-relevant searches. This surface is governed by ranking factors that differ meaningfully from standard organic SEO: proximity, Google Business Profile completeness and engagement, and local citation consistency matter more here than the backlink-and-content factors that dominate standard organic rankings.",
        ...
        "Review velocity and sentiment have become a bigger factor in local visibility than most businesses realize. Google's local algorithm reads recency and rating distribution as a signal of an actively maintained, trustworthy business. A location with strong reviews from two years ago but nothing recent sends a weaker signal than a competitor with a steady, current stream — even if the average rating is similar. That's why review generation needs to be a continuous process, not a one-time push after launch.",
        "Local search behavior is increasingly mobile and voice-driven. Searches like 'near me' and conversational location queries are growing faster than typed desktop search. Optimizing for this shift means making sure your Google Business Profile data — hours, service areas, attributes — is precise enough to surface correctly in these intent-driven queries, not just accurate enough to pass a manual glance.",
        "Local pack ranking responds to genuine proximity in ways businesses can't fully control, which makes it tempting to treat local SEO as a fixed ceiling. We push back on that framing. Within the proximity constraint that does exist, Profile completeness, review signals, and citation consistency still meaningfully shift who wins the map pack for searchers at a comparable distance — and that's the part of the equation actually worth optimizing.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Budget allocation across the funnel needs regular rebalancing rather than a fixed split set once at launch. Prospecting and retargeting audiences behave differently as an account scales, and your retargeting pool grows or shrinks with site traffic. An account that worked at a 70/30 prospecting-to-retargeting split at one budget level often needs a different ratio entirely once spend doubles. We revisit this allocation as part of ongoing management rather than leaving it static.",
        "Creative format mix matters as much as creative volume. An account running only static image ads is leaving meaningful performance on the table when video and interactive formats are tested alongside it. We diversify creative formats deliberately rather than defaulting to whichever format was easiest to produce first — Meta's delivery algorithm rewards accounts that give it more varied, high-quality creative to test against an audience.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Budget pacing on LinkedIn deserves more attention than it typically gets. LinkedIn's auction dynamics and audience sizes for tightly defined B2B segments are small enough that aggressive daily budgets can exhaust a relevant audience within days — leaving the campaign serving progressively less relevant overflow inventory for the rest of the month. We size daily budgets against actual audience size rather than treating budget pacing as a simple division of monthly spend across thirty days.",
        "Sales and marketing alignment matters more for LinkedIn than for almost any other paid channel. The value of a lead depends heavily on how quickly and effectively your sales team follows up — especially with native lead gen forms that can generate volume faster than a sales team is prepared to handle. We coordinate directly with sales on response time and qualification criteria as part of campaign setup, not as an afterthought once leads start arriving.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Trend participation is another area where TikTok rewards genuine speed and cultural fluency over polished planning cycles. A trending sound or format has a short window where it reads as current rather than dated. Brands that wait for a multi-week creative approval process to adapt a trend usually miss the window entirely. We build a lighter, faster approval workflow specifically for TikTok rather than routing every piece of creative through the same review cycle used for more deliberate channels.",
        "Comment sections on TikTok function almost as a second creative surface. Viewers actively read and engage with comments in a way that's less common on other platforms, and a brand that ignores or mishandles comments on a paid post can undercut otherwise strong creative performance. We monitor and engage with comments on active campaigns as part of ongoing management, treating community response as a genuine signal — not a separate concern from the media buying itself.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Test velocity matters almost as much as test quality. A CRO program that runs one carefully designed test per quarter compounds far more slowly than one running a steady cadence of well-prioritized tests — even if each individual test is more modest in scope. We structure programs around a sustainable testing cadence rather than treating CRO as a single big-bang redesign project with an end date. The businesses that benefit most from CRO keep testing long after the first obvious wins are claimed.",
        "Segment-level analysis often reveals that an apparent 'losing' test actually wins decisively for one traffic segment while losing for another. Averaging those results together into a single overall verdict can throw away a genuinely valuable insight. We routinely break results down by traffic source, device, and new-versus-returning visitor status before declaring a test won or lost — because the aggregate number sometimes hides the more useful, more actionable answer underneath it.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Brand identity needs to anticipate how the business will actually grow, not just reflect where it stands today. A system designed only around a single product, a single market, or a single audience tends to crack the moment the company expands — forcing an expensive redesign far sooner than necessary. We build in enough flexibility from the outset to absorb that growth without losing coherence.",
        "Internal buy-in matters as much as external market reception. A brand identity that the founding team or internal stakeholders don't genuinely believe in tends to get applied inconsistently or quietly abandoned within a year — regardless of how strong the strategic rationale was. We involve key stakeholders throughout the process specifically to build that conviction, rather than presenting a finished system at the end and hoping it lands with people who weren't part of shaping it.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Accessibility is a structural requirement we build into UX decisions from the start, not a compliance checklist applied after the visual design is finished. Color contrast, keyboard navigation, and screen reader compatibility shape real design decisions — layout, component choice, interaction pattern. Retrofitting accessibility into a design that ignored it from the outset almost always produces a worse result than designing for it from the first wireframe.",
        "Edge cases and error states deserve as much design attention as the primary happy path. Real users hit empty states, validation errors, and slow network conditions constantly — and a polished primary flow paired with neglected edge cases still produces a frustrating overall experience. We design these states deliberately rather than leaving them as an engineering afterthought filled in with whatever default the framework provides.",
      ],
    },
    whatsIncluded: {
  ...
  },
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Content strategy needs a realistic relationship with production capacity. A roadmap built around an unrealistic publishing cadence becomes a source of ongoing guilt and missed deadlines rather than an actual plan anyone follows. We size the roadmap to what your team or our production capacity can sustainably deliver — a smaller, consistently executed plan beats an ambitious one that quietly falls apart after the second month.",
        "Strategy needs to evolve as actual performance data comes in, rather than being treated as a fixed plan followed rigidly regardless of what's actually working. A topic cluster that isn't gaining traction after a reasonable runway is a signal worth acting on. We build in regular checkpoints specifically to catch and respond to these signals, rather than discovering eighteen months later that an entire content pillar never resonated.",
      ],
    },
    whatsIncluded: {
