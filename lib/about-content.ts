...
export const founders: Founder[] = [
  {
    name: "Ajaypal Singh",
    role: "Founder · SEO & Marketing",
    bio: "Ajaypal co-founded Vertexa to bring strategy, client acquisition, and growth under one roof, with a focus on SEO and digital marketing — turning organic visibility and outbound relationships into a steady pipeline of the kind of clients the rest of the founders love working with. He's the first call for any prospective client, and the person who makes sure every engagement starts with a clear, honest scope before any work begins, rather than a vague proposal that gets renegotiated halfway through the project.",
  },
  {
    name: "Manav Parihar",
  ...
  },
  {
    ...
    role: "Founder · Operations & Finance",
    bio: "Jayantilal co-founded Vertexa to ensure the numbers stay honest — operations, finance, accounting, and the research and analytics that inform how we price engagements and measure whether client work is actually performing. He's the quiet check on every claim the founders make about results, making sure 'it's working' is backed by data before it ever reaches a client report, not just a screenshot that looks good in isolation.",
  },
];
...
export const whyVertexaDifferentiators: Differentiator[] = [
  {
    title: "Built for International Standards",
    description:
