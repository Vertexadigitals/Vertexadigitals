  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          headingId="locations-timezone-heading"
          heading="How We Work Across Time Zones"
          subtext="Working with a remote agency across a real time difference is a legitimate question, not something we gloss over. The honest answer is that overlap varies meaningfully by region — UK and EU clients get 5-6 hours of daily real-time overlap, Australian clients get a genuinely favorable 4-5 hours, and US clients get 2-4 hours depending on the specific city and coast."
        />
