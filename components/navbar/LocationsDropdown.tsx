                ...
                {cities.map((city) => (
                  <li key={city.slug}>
                    <Link
                      ...
                      role="menuitem"
                      onClick={onNavigate}
                      className="block rounded-lg px-2 py-1.5 text-sm text-neutral-700 transition-colors hover:bg-neutral-50 hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2"
                    >
                      {city.city}
                    </Link>
                  </li>
